...
## Logging Issues
All issues should be created using the [new issue form](https://github.com/devinivy/dogwater/issues/new). Clearly describe the issue including steps
...
* [Pull requests](http://help.github.com/send-pull-requests/) should be made to the [master branch](https://github.com/devinivy/dogwater/tree/master) or in certain special cases, the branch for a relevant [milestone](https://github.com/devinivy/dogwater/milestones).
